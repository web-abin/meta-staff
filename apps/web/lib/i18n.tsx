...
const M = {
  ...
  "new_emp.user_id": { zh: "用户 ID", en: "User ID" },
  "new_emp.user_id_placeholder": { zh: "粘贴对方注册时拿到的用户 ID", en: "Paste the user's account ID" },
  "new_emp.user_id_hint": { zh: "可以让对方在「个人信息」里复制，也可以下方挑选已注册用户", en: "Ask them to copy from Profile, or pick below" },
  "new_emp.user_pick_existing": { zh: "或从已注册用户里选一个", en: "Or pick a registered user" },
  "new_emp.user_required": { zh: "请填写用户 ID 或选择用户", en: "User ID required" },
  "new_emp.display_name": { zh: "显示名（可选）", en: "Display name (optional)" },
  "new_emp.display_name_placeholder": { zh: "不填默认用对方账号名", en: "Defaults to the user's name" },
  "new_emp.avatar": { zh: "头像字（可选）", en: "Avatar letter (optional)" },
